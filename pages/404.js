...
export default function Home() {
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center h-adaptive bg-transparent backdrop-blur-sm rounded-2xl mt-8 mx-16 border-2 border-gray-200 shadow-lg">
